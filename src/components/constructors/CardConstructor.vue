<template>
	<div class="card py-3 focus-highlight-border border-0 bg-transparent align-items-center">
		<div class="row w-100 g-0">
			<div class="col-12">
				<div class="card-body bg-standart hover-highlight special-hover d-flex flex-column justify-content-between">
					<div>
						<div class="row g-0 d-flex align-items-center px-2 pt-2 position-relative">
							<div class="row g-0 d-flex flex-nowrap mb-3 align-items-stretch">
								<div
									v-if="type === 'movie'"
									class="col img-parent d-flex align-items-center"
						...
						>
							<div class="w-auto justify-content-start align-items-center d-flex flex-nowrap">
							...
							<div class="w-auto justify-content-end align-items-center d-flex flex-nowrap">
								<control-dropdown :type="type" :userCredentials="userCredentials" :colorScheme="colorScheme" />
							</div>
						</div>
					</div>
				</div>
...
<style>
	/**  will be considered on next commits to improve ui **/
	/* [data-bs-theme='dark'] .card .card-body > div::before {
		background-image: radial-gradient(transparent 75%, black),
			url(https://image.tmdb.org/t/p/w500/wPU78OPN4BYEgWYdXyg0phMee64.jpg);
	}

	[data-bs-theme='light'] .card .card-body > div::before {
		background-image: radial-gradient(#ffffff60 75%, #000000),
			url(https://image.tmdb.org/t/p/w500/wPU78OPN4BYEgWYdXyg0phMee64.jpg);
	}
	...
	[data-bs-theme='dark'] .card .card-body span {
		text-shadow: 0.125rem 0.175rem 0.35rem rgb(0 0 0 / 30%);
	}

	[data-bs-theme='dark'] .card .card-body span.small:not(.fw-bold) {
		text-shadow: 0.125rem 0.175rem 0.35rem rgb(0 0 0 / 80%) !important;
	}

	[data-bs-theme='dark'] .card .card-body .img-parent {
		box-shadow: 0 0.125rem 0.65rem rgb(0 0 0 / 15%) !important;
	}

	[data-bs-theme='light'] .card .card-body span {
		text-shadow: 0.125rem 0.175rem 0.35rem rgb(120 120 120 / 20%);
	}

	[data-bs-theme='light'] .card .card-body span.small:not(.fw-bold) {
		text-shadow: 0.125rem 0.175rem 0.35rem rgb(120 120 120 / 60%) !important;
	}

	[data-bs-theme='light'] .card .card-body .img-parent {
		box-shadow: 0 0.125rem 0.65rem rgb(120 120 120 / 10%) !important;
	} */
</style>
